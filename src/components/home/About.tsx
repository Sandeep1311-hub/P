      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-10 lg:gap-16">
          <div className="w-full md:w-5/12 lg:w-4/12 flex justify-center">
            <div className="relative aspect-square w-full max-w-xs rounded-2xl overflow-hidden shadow-xl border border-primary/10 grayscale hover:grayscale-0 transition-all duration-500">
              <Image
          ...
          <div className="w-full md:w-7/12 lg:w-8/12 space-y-5">
            <h2 className="text-lg md:text-xl font-bold tracking-tight uppercase text-primary font-mono tracking-widest">About Me</h2>
